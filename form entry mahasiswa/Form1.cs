...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0001", Name = "ALIF", Gender = "Laki-laki", Born="Jakarta",Date="10/10/1998",Alamat="Jakarta" });
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0002", Name = "RENATA", Gender = "Perempuan",Born="JAYAPURA",Date="11/10/1999",Alamat="JAYAPURA" });
